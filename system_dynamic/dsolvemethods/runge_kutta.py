    ...
    def solve(
        ...
        for _ in range(round(period / self.h)):
            ...
            k_2 = cauchy_problem.derivative(
                args[-1] + self.h / 2, values[-1] + self.h * k_1 / 2
            )
            k_3 = cauchy_problem.derivative(
                args[-1] + self.h / 2, values[-1] + self.h * k_2 / 2
            )
            k_4 = cauchy_problem.derivative(
                args[-1] + self.h, values[-1] + self.h * k_3
            )
